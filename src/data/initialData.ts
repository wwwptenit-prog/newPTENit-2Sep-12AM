...
export const initialSiteSettings: SiteSettings = {
  ...
  heroPhotoUrl: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?auto=format&fit=crop&w=1200&q=85",
  statsStudents: "500+",
  statsProjects: "100+",
  statsCourses: "50+",
  ...
  logoBoxLetter: "P",
  logoTextMain: "PTEN",
  logoTextHighlight: "it",
  logoSubtitle: "IT Services & Training",
  marketplaceLogoSubtitle: "Marketplace & Services",
  ...
  // Payment Automation Gateway Defaults
  paymentAutomationMode: "manual", // Default is manual with admin approval. Set to "automated" when gateway API keys are ready.
  selectedGateway: "bkash_pgw",
  gatewaySandboxMode: true,
  bkashAppKey: "",
  bkashAppSecret: "",
  bkashUsername: "",
  bkashPassword: "",
  gatewayStoreId: "",
  gatewayStorePassword: "",
  autoApproveOnGatewaySuccess: true,
  paymentLogos: [
    {
      id: "pay-bkash",
      name: "bKash",
...
export const initialCourses: Course[] = [
  {
    ...
    liveClassTopic: 'ক্যানভা প্রো ও ফ্রিল্যান্সিং কমপ্লিট সেশন (আর্কাইভ)',
