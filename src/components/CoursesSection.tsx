  ...
  return (
    <section className={`py-8 sm:py-12 bg-white dark:bg-slate-900 ${isStandalonePage ? 'min-h-screen' : ''} font-bengali`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between gap-3 border-b border-slate-200 dark:border-slate-800 pb-3 mb-4 sm:mb-8">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <div className="relative w-full md:w-80">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-white text-xs sm:text-sm focus:outline-none focus:border-[#006A4E]"
                />
              </div>
                  ...
                  <button
                    ...
                    className={`px-3.5 py-1.5 rounded-lg text-xs font-black transition-all cursor-pointer whitespace-nowrap flex items-center gap-1.5 ${
                      pricingFilter === 'Enrolled'
                        ...
                        : 'text-[#006A4E] hover:bg-[#006A4E]/10'
                    }`}
                  >
