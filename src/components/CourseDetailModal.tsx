  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-50 dark:bg-slate-950 overflow-y-auto min-h-screen font-bengali p-2 sm:p-4 md:p-6 lg:p-8 animate-fadeIn text-slate-800 dark:text-slate-100">
      <div className="max-w-6xl mx-auto space-y-3 sm:space-y-4">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl sm:rounded-3xl overflow-hidden shadow-xs">
          ...
          <div className="sticky top-0 z-30 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 px-3 sm:px-4 py-2 sm:py-2.5 flex items-center justify-between gap-2 shadow-xs">
            ...
            {/* CENTER: কোর্স হলে সম্পূর্ণ ফ্রি কোর্স বা প্রিমিয়াম কোর্স (বর্ডার ছাড়া গাড় সবুজ প্লেন টেক্সট) */}
